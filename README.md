# MGScoliosis
This repo is the official implementation of "MGScoliosis: Multi-Grained Scoliosis Detection with Joint Ordinal Regression from Natural Image" accepted by Alexandria Engineering Journal.
